...
class UsersList extends React.Component {
  ...
  state = {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        cellRendererFramework: params => {
          return (
            <div className="actions cursor-pointer" id={params?.data?.transection_id}>
                <Button.Ripple
                    color="success"
                    type="button"
                    className="mr-2"
                    onClick={() => this.updateWithdrawalStatus(params?.data?.transection_id,"approved",params?.data?.user_id, params?.data?.symbol)}
                >
                    Approve
                </Button.Ripple>
                <Button.Ripple
                    ...
                    type="button"
                    className="mr-2"
                    onClick={() => this.updateWithdrawalStatus(params.data.transection_id,"reject",params.data.user_id, params.data.symbol)}
                >
                    Reject
                </Button.Ripple>
              <Edit
  ...
  updateWithdrawalStatus = (transection_id,action,user_id, symbol, txt) => {
    document.getElementById(transection_id).style.display = 'none';
    const alltxtData = {
    ...
    postAPICall('admin/withdraw-crypto',alltxtData)
    .then(response => {
