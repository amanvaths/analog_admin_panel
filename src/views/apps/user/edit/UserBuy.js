...
class UserBuy extends React.Component {
  state = {
    rowData: null,
    pageSize: 20,
    isVisible: true,
  ...
  async componentDidMount() {
   getAPICall("getAllOrder"+window.location.search).then((d)=>{
      if(d.status === 200){
        const deposit_data = d.data.order;
            ...
            <CardBody>
              <div className="ag-theme-material ag-grid-table">
                <div className="ag-grid-actions d-flex justify-content-between flex-wrap mb-1">
                  ...
                  <div className="">
                    <div className="h2 float-left">Buy Detail : {this.state.rowData !== null ? this.state.rowData.length : 0 }</div>
                  </div>
