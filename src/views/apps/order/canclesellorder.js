...
class UsersList extends React.Component {
  ...
  async componentDidMount() {
    ...
    getAPICall('get-all-order?action=sell&status=2&admin_user_id='+this.state.currentUserId + params)
      .then(response => {
    ...
    if (this.state.gridApi !== prevState.gridApi) {
      const dataSource = {
        getRows: (rowData) => {
          ...
          let params = '?action=sell&status=2&admin_user_id='+this.state.currentUserId + "&per_page=" + this.state.pageSize + "&page=" + page;
  ...
  // async componentDidMount() {
  //   getAPICall('get-all-order?action=sell&status=2&admin_user_id='+this.state.currentUserId)
  //   .then(response => {
  //     const rowData = response.data.result;
  //     if(rowData){
  //       this.setState({ rowData });
