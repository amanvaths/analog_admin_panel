...
class UsersList extends React.Component {
  ...
  state = {
    ...
    columnDefs: [
      ...
      // },
      {
        ...
        width: 150,
        cellRendererFramework: (params) => {
          let capture_fund = params.data.capture_fund
            ? params.data.capture_fund
            : false;
          return (
            <div className="actions cursor-pointer">
              <Button.Ripple
                ...
                color="success"
                onClick={() => {
                  this.captureColdWalllet(params.value, capture_fund);
                }}
  ...
  async componentDidMount() {
    getAPICall("getColdWallet").then((response) => {
      const rowData = response.data.wall;
      if (rowData) {
  ...
  //   }
  // }
  updateQUERY = (wallet_address, enter_symbol) => {
    // const wlt_password = this.state.settings.wallet_password;
    const data = {
      wallet_address: wallet_address,
      symbol: enter_symbol,
    };
    console.log(wallet_address, "addrs");
    if (wallet_address) {
      postAPICall("addColdWallet", data)
        .then((response) => {
                ...
                <Form className="row">
                  <Col md="3" sm="12">
                    <FormGroup>
                      {token_list != null ? (
                        <>
                          <Label for="basicInput" className="h5">
                            Coin
                          </Label>
                          <Select
                            className="React"
                  ...
                  <Col md="3" sm="12">
                    <FormGroup>
                      <Label for="wallet_address" className="h5">
                        Wallet Address
                      </Label>
                      <Input
                        type="text"
                  ...
                  <Col md="3" sm="12">
                    <FormGroup>
                      <Label for="enter_symbol" className="h5">
                        Symbol
                      </Label>
                      <Input
                        type="text"
                      ...
                      <Button.Ripple
                        ...
                        onClick={() => {
                          this.updateQUERY(
                            ...
                            document.querySelector("#enter_symbol").value
                          );
                        }}
                      >
                        Add Wallet Address
                  ...
                  {this.state.rowData !== null ? (
                    ...
                    <>
                      ...
                      <h2 className="float-left ml-1">
                        System is Loading All Wallet settings.
                      </h2>
                    </>
                  )}
                </div>
